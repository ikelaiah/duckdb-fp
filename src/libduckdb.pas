...
type
  ...
  Pduckdb_time_ns = ^duckdb_time_ns;
  ...
  P_duckdb_client_context = ^_duckdb_client_context;
  ...
  //! A client context of a duckdb connection. Must be destroyed with `duckdb_destroy_context`.
  duckdb_client_context = P_duckdb_client_context;
  Pduckdb_client_context = ^duckdb_client_context;
